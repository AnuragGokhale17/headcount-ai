...
try:
    ...
    def hooked_get_transform(alignment_data, proj_mat0, proj_mat1):
        ...
        print("alignment_data type:", type(alignment_data))
        print("proj_mat0 type:", type(proj_mat0))
        print("proj_mat1 type:", type(proj_mat1))
        
        if proj_mat0 is not None:
            print("proj_mat0 keys:", proj_mat0.keys() if isinstance(proj_mat0, dict) else "Not a dict")
        if proj_mat1 is not None:
            print("proj_mat1 keys:", proj_mat1.keys() if isinstance(proj_mat1, dict) else "Not a dict")
